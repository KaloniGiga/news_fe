...
const CreatePostList: FunctionComponent<ICreatePostList> = ({ newsPostData, hasMoreData, loadMoreData }) => {
        ...
        <AutoSizer disableHeight>
          {({ width }) => {
            ...
            const rowRenderer = ({ index, style }: any) => {
              ...
              return (
                <div style={style} className="w-full pl-10">
